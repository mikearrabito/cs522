...
public class TextAdapter<T> extends RecyclerView.Adapter<TextAdapter.ViewHolder> implements RecyclerView.OnChildAttachStateChangeListener, View.OnClickListener {
