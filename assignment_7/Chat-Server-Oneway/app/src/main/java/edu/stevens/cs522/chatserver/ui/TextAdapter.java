...
public class TextAdapter<T>
        extends RecyclerView.Adapter<TextAdapter.ViewHolder>
    ...
    public void onClick(View row) {
        if (listener != null) {
            ...
            int position = childViewHolder.getAdapterPosition(); // getAbsoluteAdapterPosition() or getBindingAdapterPosition()
